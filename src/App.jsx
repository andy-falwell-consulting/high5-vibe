  ...
  return (
    <div data-theme={theme} style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', flex: 1, minHeight: 0, overflow: 'hidden' }}>
        ...
        {visited.has('trainings') && <div style={{ display: activeModule === 'trainings' ? 'contents' : 'none' }}><Trainings navTarget={navTarget} onClearNav={clearNavTarget} onNavigateApp={navigateTo} onRecordSelect={makeRecordSelectHandler('trainings')} /></div>}
