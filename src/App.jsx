...
export default function App() {
  ...
  return (
    <div data-theme={theme} style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
      ...
      <QboHealthBanner isAdmin={isAdmin} />
      ...
      <div style={{ display: 'flex', flex: 1, minHeight: 0, overflow: 'hidden' }}>
        ...
        {visited.has('trainings') && <div style={{ display: activeModule === 'trainings' ? 'contents' : 'none' }}><TrainingsWorkspace navTarget={navTarget} onClearNav={clearNavTarget} onNavigateApp={navigateTo} onRecordSelect={makeRecordSelectHandler('trainings')} /></div>}
